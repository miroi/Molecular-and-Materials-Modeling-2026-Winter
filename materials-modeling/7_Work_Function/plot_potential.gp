...
# Fermi level line
set arrow from graph 0, first -1.7174 to graph 1, first -1.7174 nohead linestyle 3
...
plot 'potential_results/avg.dat' using ($1*0.529177):($2*13.6058) with lines linestyle 1 title 'Planar Average', \
     ...
     -1.7174 with lines linestyle 3 title 'Fermi Level (-1.717 eV)'

# Add some annotations
set label "Cell length: 15.0 Å" at graph 0.05,0.95
set label "Fermi level: -1.717 eV" at graph 0.05,0.88
